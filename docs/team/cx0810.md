...
* **New Feature**: Added list abilities
  ...
  * Highlights: This enhancement is linked to the buttons available in the UI, where users are able to simply click on Clients or Orders to view the lists as well. 
